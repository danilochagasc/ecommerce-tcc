...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.2\textwidth]{imgs/diagrama_solucao_1.pdf}
    \caption{Diagrama da estrutura geral da solução de microsserviços.}
    \label{fig:diagrama-solucao}
\end{figure}
