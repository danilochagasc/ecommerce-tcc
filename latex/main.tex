...
pdftitle={TCC Danilo},
% Autor
pdfauthor={Danilo Chagas Clemente},
% Descrição
pdfsubject={Trabalho de Conclusão de Curso - Danilo Chagas Clemente},
% Palavras-Chave
...
\author{Danilo Chagas Clemente}

% Título do trabalho, em lígua vernácula
\title{Uma abordagem prática sobre a arquitetura de microsserviços no desenvolvimento de sistemas}
...
% \engtitle{A Practical Approach to Microservices Architecture in Modern System Development}

% Subítulo do trabalho, em inglês
% \engsubtitle{A Practical Approach to Microservices Architecture in Modern System Development}
...
% Tipo do Documento
\tipo{Trabalho de Conclusão de Curso apresentado à Universidade Federal de Lavras, como parte das exigências para obtenção do título de Bacharel em Ciência da Computação.}
...
\include{secoes/fundamentacao_teorica}
